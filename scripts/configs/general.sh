...
NOTIFICATION_ENABLED=${P_DYNAMIC_ISLAND_NOTIFICATION_ENABLED:=0}
VOLUME_ENABLED=${P_DYNAMIC_ISLAND_VOLUME_ENABLED:=1}
BRIGHTNESS_ENABLED=${P_DYNAMIC_ISLAND_BRIGHTNESS_ENABLED:=1}

# DYNAMIC ISLAND DISPLAY SETTINGS:
DISPLAY_PRIMARY=${P_DYNAMIC_ISLAND_DISPLAY:="Primary"}
