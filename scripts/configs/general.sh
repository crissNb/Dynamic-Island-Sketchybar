...
ICON_HIDDEN=${P_DYNAMIC_ISLAND_ICON_HIDDEN:=$PITCH_BLACK}
DEFAULT_LABEL=${P_DYNAMIC_ISLAND_DEFAULT_LABEL:=$WHITE}
TRANSPARENT_LABEL=${P_DYNAMIC_ISLAND_TRANSPARENT_LABEL:=$TRANSPARENT}
